...
function mesmerize_setup()
{
    ...
    register_default_headers(array(
        'homepage-image' => array(
            'url'           => apply_filters('mesmerize_assets_url','%s/assets/images/home_page_header.jpg','/assets/images/home_page_header.jpg'),
            'thumbnail_url' => apply_filters('mesmerize_assets_url','%s/assets/images/home_page_header.jpg','/assets/images/home_page_header.jpg'),
