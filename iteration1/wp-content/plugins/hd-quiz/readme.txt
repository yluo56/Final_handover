...
= NOTICE ⚠️ =
This version, 1.6.0 (released January 26th) is a major code and UI change. I have completely rewritten HD Quiz from the ground up. Upgrading to this version should not cause any issues, but if you do experience a problem, please do not hesitate to ask for support.
...
* ability to add score percent
* ability to allow authors access to edit or add quizzes / questions
V1.6.0 was a massive rewrite of almost the entire plugin. Please do not hesitate to ask for support if needed, but upgrading should not be an issue.
