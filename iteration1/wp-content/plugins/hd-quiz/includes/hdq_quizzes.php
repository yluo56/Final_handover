...
<div id = "hdq_meta_forms">
	<div id = "hdq_wrapper" class = "hdq_quizzes_admin">
		...
		<div id="hdq_form_wrapper">
			...
			<a href = "./edit.php?post_type=post_type_questionna" class = "hdq_button4"><span class="dashicons dashicons-trash"></span> DELETE QUESTIONS</a>
			...
			<div id = "hdq_list_quizzes">
                    ...
                    if (! empty($tax_terms) && ! is_wp_error($tax_terms)) {
                        foreach ($tax_terms as $tax_terms) {
                            ?>
								<div class = "hdq_quiz_item hdq_quiz_term" data-id = "<?php echo $tax_terms->term_id; ?>"><?php echo mb_strimwidth($tax_terms->name, 0, 50, "..."); ?> <code>[HDquiz quiz = "<?php echo $tax_terms->term_id; ?>"]</code>
</div>
					<?php
                        }
                    }
