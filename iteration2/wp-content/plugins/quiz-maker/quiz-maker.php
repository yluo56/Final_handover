...
if(get_option('timezone_string') != ""){
    ...
    date_default_timezone_set(timezone_name_from_abbr("", intval(get_option('gmt_offset'))*3600, false));
}else{
    date_default_timezone_set( timezone_name_from_abbr("", date('P')*3600, false) );
}
 ...
 */
define( 'AYS_QUIZ_NAME_VERSION', '4.3.0' );
define( 'AYS_QUIZ_VERSION', '4.3.0' );
         ...
         <div class="ays-notice-banner">
            <div class="navigation-bar">
                <div id="navigation-container">
                    ...
                    <ul id="menu">
                        <li><a class="ays-btn" href="https://ays-pro.com/index.php/wordpress/quiz-maker/" target="_blank">PRO</a></li>
                        ...
                        <li><a class="ays-btn" href="https://freedemo.ays-pro.com/quiz-maker-demo-free/" target="_blank">Demo</a></li>
                        <li><a class="ays-btn" href="https://wordpress.org/support/plugin/quiz-maker/" target="_blank">Support Forum</a></li>
                        <li><a class="ays-btn" href="http://bit.ly/2tLbooO" target="_blank">Take a survey</a></li>
