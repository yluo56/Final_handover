...
<div class="wrap">
    <div class="ays-quiz-maker-wrapper" style="position:relative;">
        ...
        <button class="ays-pulse-button" id="ays_quick_start" title="Quick quiz" data-container="body" data-toggle="popover" data-placement="right" data-content="<?php echo __('Build your quiz in a few minutes',$this->plugin_name)?>"></button>
