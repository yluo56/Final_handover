    ...
    <div class="container-fluid">
        ...
        <form class="ays-quiz-category-form" id="ays-quiz-category-form" method="post">
            <div class="form-group row">
                <div class="col-sm-2">
                    <label for='ays-title'><?php echo __('Title', $this->plugin_name); ?></label>
                </div>
                <div class="col-sm-10">
            ...
            <hr/>
            <div class='ays-field'>
                <label for='ays-description'><?php echo __('Description', $this->plugin_name); ?></label>
                <?php
            ...
            <div class="form-group row">
                <div class="col-sm-2">
                    <label><?php echo __('Category status', $this->plugin_name); ?></label>
                </div>
            ...
            <?php
                ...
                submit_button( __( 'Save Category', $this->plugin_name ), 'primary', 'ays_submit', true, $other_attributes );
                submit_button(__('Apply Category', $this->plugin_name), '', 'ays_apply', true, $other_attributes);
