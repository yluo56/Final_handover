...
* Woocommerce extension - This [extension](http://www.getcloudsms.com/downloads/joy-of-text-woocommerce-integration-extension/) - will send out new order notifications and will let you sync Woo customers into JOT, allowing you to send SMS messages to your valued customer base.
* Message Scheduling extension - The [Scheduler extension](http://www.getcloudsms.com/downloads/joy-text-message-scheduler-extension/) allows you to schedule messages to be sent at a future date and time.
* Post and comment Notifier - The [Notifier](http://www.getcloudsms.com/downloads/joy-of-text-post-and-comment-wordpress-sms-notifier/) will send SMS notifications to your customers, when a new post is added or updated.
* Buddypress integration extension - This [extension](https://www.getcloudsms.com/downloads/joy-text-buddypress-extension/) synchronises your BuddyPress members into the Joy Of Text Lite.
...
A number of [extensions](https://www.getcloudsms.com/products/) are available for the Pro and Lite versions. For example, the Pro version can be integrated with
