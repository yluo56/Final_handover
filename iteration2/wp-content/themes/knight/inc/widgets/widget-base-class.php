 ...
 * @since 1.0.0
 */
class Knight_Widget_Base extends WP_Widget
{
            ...
            case 'image':
                ...
                <div>
                    ...
                    <input type="button" class="select-img button button-primary"
                           value="<?php esc_attr_e('Upload', 'knight'); ?>"
                           data-uploader_title="<?php esc_attr_e('Select Image', 'knight'); ?>"
                           data-uploader_button_text="<?php esc_attr_e('Choose Image', 'knight'); ?>"/>
                    <?php
                    $image_status = false;
                    if (!empty($value)) {
                        $image_status = true;
                    ...
                    ?>
                    <input type="button" value="<?php echo esc_attr_x('X', 'Remove', 'knight'); ?>"
