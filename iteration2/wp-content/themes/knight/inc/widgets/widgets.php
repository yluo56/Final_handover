...
if (!function_exists('knight_load_widgets')) :
    /**
     * Load widgets.
     *
     * @since 1.0.0
     */
    function knight_load_widgets()
    {
        // Recent Post widget.
...
add_action('widgets_init', 'knight_load_widgets');
...
if (!class_exists('TWP_sidebar_widget')) :
     ...
     * @since 1.0.0
     */
    class TWP_sidebar_widget extends Knight_Widget_Base
    {
        ...
        {
            $opts = array(
                'classname' => 'knight_popular_post_widget',
                'description' => esc_html__('Displays post form selected category specific for popular post in sidebars.', 'knight'),
                'customize_selective_refresh' => true,
            );
            $fields = array(
                'title' => array(
                    'label' => esc_html__('Title:', 'knight'),
                    'type' => 'text',
                    'class' => 'widefat',
                ),
                'post_category' => array(
                    'label' => esc_html__('Select Category:', 'knight'),
                    'type' => 'dropdown-taxonomies',
                    'show_option_all' => esc_html__('All Categories', 'knight'),
                ),
                'post_number' => array(
                    'label' => esc_html__('Number of Posts:', 'knight'),
                    'type' => 'number',
                    'default' => 4,
                    'css' => 'max-width:60px;',
                    'min' => 1,
            ...
            parent::__construct('knight-popular-sidebar-layout', esc_html__('Knight: Recent Post', 'knight'), $opts, array(), $fields);
        }
...
if (!class_exists('TWP_Author_Post_widget')) :
     ...
     * @since 1.0.0
     */
    class TWP_Author_Post_widget extends Knight_Widget_Base
    {
        ...
        {
            $opts = array(
                'classname' => 'knight_author_widget',
                'description' => esc_html__('Displays authors details in post.', 'knight'),
                'customize_selective_refresh' => true,
            );
            $fields = array(
                'title' => array(
                ...
                'author-name' => array(
                    'label' => esc_html__('Name:', 'knight'),
                    'type' => 'text',
                    'class' => 'widefat',
                ),
                'discription' => array(
                    'label' => esc_html__('Discription:', 'knight'),
                    'type' => 'textarea',
                    'class' => 'widget-content widefat'
                ),
                'image_url' => array(
                    'label' => esc_html__('Author Image:', 'knight'),
                    'type' => 'image',
                ),
                'url-fb' => array(
                    'label' => esc_html__('Facebook URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-tw' => array(
                    'label' => esc_html__('Twitter URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-gp' => array(
                    'label' => esc_html__('Googleplus URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
            );

            parent::__construct('knight-author-layout', esc_html__('Knight: Author Widget', 'knight'), $opts, array(), $fields);
        }
                ...
                <div class="author-social">
                    ...
                    <?php if (!empty($params['url-gp'])) { ?>
                            <a href="<?php echo esc_url($params['url-gp']); ?>" target="_blank">
                                <i class="meta-icon ion-social-googleplus"></i>
                            </a>
                    <?php } ?>
                </div><!-- /#author-social -->
...
if (!class_exists('TWP_Social_widget')) :
     ...
     * @since 1.0.0
     */
    class TWP_Social_widget extends Knight_Widget_Base
    {
        ...
        {
            $opts = array(
                'classname' => 'knight_social_widget',
                'description' => esc_html__('Displays Social share.', 'knight'),
                'customize_selective_refresh' => true,
            );
            $fields = array(
                'title' => array(
                ...
                'url-lt' => array(
                    'label' => esc_html__('Linkedin URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-ig' => array(
                    'label' => esc_html__('Instagram URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-pt' => array(
                    'label' => esc_html__('Pinterest URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-rt' => array(
                    'label' => esc_html__('Reddit URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-sk' => array(
                    'label' => esc_html__('Skype URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-sc' => array(
                    'label' => esc_html__('Snapchat URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-tr' => array(
                    'label' => esc_html__('Tumblr URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-th' => array(
                    'label' => esc_html__('Twitch URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-yt' => array(
                    'label' => esc_html__('Youtube URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-vo' => array(
                    'label' => esc_html__('Vimeo URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-wa' => array(
                    'label' => esc_html__('Whatsapp URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-wp' => array(
                    'label' => esc_html__('WordPress URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-gh' => array(
                    'label' => esc_html__('Github URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-fs' => array(
                    'label' => esc_html__('FourSquare URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
                'url-db' => array(
                    'label' => esc_html__('Dribbble URL:', 'knight'),
                    'type' => 'url',
                    'class' => 'widefat',
                ),
            );

            parent::__construct('knight-social-layout', esc_html__('Knight: Social Widget', 'knight'), $opts, array(), $fields);
        }
