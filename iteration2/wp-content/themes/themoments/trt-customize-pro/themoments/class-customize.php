		...
		$manager->add_section(
			new Themoments_Customize_Section_Pro(
				...
				array(
					...
					'pro_text' => esc_html__( 'Upgrade to Pro', 'themoments' ),
					'pro_url'  => esc_url( 'https://thebootstrapthemes.com/downloads/photography-bootstrap-wordpress-theme-themoments-pro/' ),
					'priority' => 1
				)
			)
		);
