      ...
      <div class="row">
        <div class="col-md-6">
			<div class="site-info">
				...
				<?php
				/* translators: placeholder replaced with string */
				printf( esc_html__( 'Theme: %1$s by %2$s.', 'busiway' ), 'Busiup', '<a href="' . esc_url( __( 'https://themeansar.com/', 'busiway' ) ) . '" rel="designer">Themeansar</a>' );
				?>		
			</div>
		</div>
        <div class="col-md-6 text-right">
		  ...
		  <ul class="ti-social">
			...
			<li><span class="icon-soci"><a <?php if($consultup_footer_insta_target) { ?>target="_blank" <?php } ?> href="<?php echo esc_url($consultup_footer_insta_link); ?>"><i class="fa fa-pinterest-p"></i></a></span></li>
			<?php } ?>
		  </ul>
		  <?php } ?>
