...
if ( ! function_exists( 'themoments_setup' ) ) :
	...
	function themoments_setup() {
		...
		**/
		...
		// Define Image Sizes:
		add_image_size( 'about-page', 576, 384, true );
		add_image_size( 'slider', 1140, 500, true );
		add_image_size( 'post-thumbs', 465, 310, true );
	}	// themoments_setup
endif; 
...
if( ! function_exists( 'themoments_home_section_enable') ):
/**
 * Check if home page section are enable or not.
*/
    function themoments_home_section_enable(){

        $themoments_sections = array( 'themoments-home-about-page', 'themoments-home-slider-page-1', 'themoments-home-slider-page-2', 'themoments-home-slider-page-3', 'features_display', 'testimonial_display', 'crew_display', 'client_display' );       
        $enable_section = false;
        foreach( $themoments_sections as $section ){ 
