...
License: GPLv2
  ...
  Copyright 2013-2018 Michael Atkins
...
*
*/
define( 'CC_AUDIOALBUM_VERSION', '1.3.1' );
...
function cc_audiotrackpopup_script() {
	wp_register_script( 'audiotrackpopup', plugins_url( '/js/audiotrackpopup.js' , __FILE__ ), array( 'jquery' ), CC_AUDIOALBUM_VERSION, true );
}
