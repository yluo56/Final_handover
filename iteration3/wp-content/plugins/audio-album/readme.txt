...
Displays a collection of audio tracks as an audio album using the native WordPress audio features. v1.3.0 includes a customizer section.

== Description ==

The plugin was originally created for [Dave Draper's](http://davedrapercreations.co.uk/ "Dave Draper") website where the it is used on the music pages. For an example, please see the page for the [Wild Bunch album](http://davedrapercreations.co.uk/music/the-wild-bunch/ "The Wild Bunch") featuring Dave on vocals and bass.
